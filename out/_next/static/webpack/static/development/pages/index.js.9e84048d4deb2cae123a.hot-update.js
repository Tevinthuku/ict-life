...
function RecipeReviewCard(_ref, current) {
  var name = _ref.name,
      image = _ref.image,
      description = _ref.description,
      prices = _ref.prices;
  var classes = useStyles();
  console.log(mapCurrency(getCurrencyFromLocalStorage()));
  debugger;
  var data = prices.find(function (_ref2) {
    var currency = _ref2.currency;
    return currency === mapCurrency(getCurrencyFromLocalStorage());
  });
...
//# sourceMappingURL=index.js.9e84048d4deb2cae123a.hot-update.js.map